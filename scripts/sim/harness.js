...
const PRODUCTION_SHEET_ID = '1XQaKGJL5uoE3yFw4Z0wiSfAlc-JnufS2Z7psODuDcA0';
...
function validateSimulationConfig(options = {}) {
  ...
  if (sheetId === PRODUCTION_SHEET_ID) {
    throw new Error(`Simulation write mode refused: sheet ID ${PRODUCTION_SHEET_ID} is the production Atlas MASTER sheet.`);
  }
  if (sheetId !== SANDBOX_SHEET_ID) {
    throw new Error(`Simulation write mode refused: expected sandbox sheet ID ${SANDBOX_SHEET_ID}, received ${sheetId}.`);
  }
