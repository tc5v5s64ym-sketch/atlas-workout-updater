...
> **Current active milestone:** ATLAS RECOVERY CAMPAIGN — Phase 3 (Shadow the packet and the trace). Phase 2 (Inventory, contracts, and clean paper) COMPLETE 2026-07-21. Phase 1 (Soul Recovery, Issue #1073) CLOSED 2026-07-20 — the owner Soul gate PASSED, so the Phases 2–7 freeze is lifted; the recovery campaign remains the active work through Phase 7 (see the "Active campaign: Atlas Recovery Campaign" section below).
...
**Adopted:** 2026-07-19 · **Controlling owner insertion** · **Status: ACTIVE — Phase 3** (Phase 2 — Inventory, contracts, and clean paper — COMPLETE 2026-07-21; Phase 1 — Soul Recovery — CLOSED 2026-07-20, owner Soul gate PASSED).
