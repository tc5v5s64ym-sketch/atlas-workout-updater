...
- `CLAUDE.md` — operating brief for Claude Code and other AI agents. Includes the **gstack Workflow** section — the canonical reference for when to use installed gstack skills (`/investigate`, `/plan-eng-review`, `/careful`, `/review`, `/qa`, `/ship`).
