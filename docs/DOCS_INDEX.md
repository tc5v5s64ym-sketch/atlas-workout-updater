...
- `docs/REMEDIATION_PLAN_V2.md` — **Active** (v2.2, 2026-07-08): remediation is **closed** — PR-21 (governance diet) and PR-22 (frontend de-dup) are both ✅ shipped. **Now/next, unambiguous:** the consolidation queue, PR-23 (Flight-Recorder replay harness) runs next → PR-24 (state-store completion). PR-18 deferred behind PR-23; PR-19 dormant; PR-20 cut; GATE A / PR-12A/B moved to the product track.
