...
// recentWorkingWeight / deloadFillerWeight now live in services/deloadPolicy.js
// (Step 1C) and are imported above — used by the deload-day filler dose below.

// effortVerdict (the effort read from logged RIR vs target) now lives in
// services/justLoggedAnchor.js (One-Brain migration item 8) and is imported +
// re-exported above/below so every consumer is unchanged.
...
// recommendFromJustLoggedSet (the in-workout just-logged anchor) now lives in
// services/justLoggedAnchor.js (One-Brain migration item 8) and is imported above.

// detectDeloadRecovery (the post-deload recovery decision) now lives in
// services/deloadPolicy.js (Step 1C) and is imported above.
